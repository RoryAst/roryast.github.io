...
// Initialize the application only if it's the main page with calendar functionality
if (typeof window !== 'undefined' && window.document) {
    // Check if calendar-related elements exist before initializing
    if (document.getElementById('eventForm') || document.querySelector('.calendar-day')) {
        window.app = new iCalendarGenerator();
    }
}
